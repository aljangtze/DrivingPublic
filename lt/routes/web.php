...
Route::get("tel/xyxc/{nickname?}", "pho\xyCenter\LcController@xc");
Route::get("tel/seljx/{nickname?}", "pho\xyCenter\LcController@seljx");
Route::get("tel/seljxdetail/{id}/{nickname?}", "pho\xyCenter\LcController@seljxdetail");

/*
 * 教练详情
 */
Route::get("tel/seljl/{nickname?}", "pho\xyCenter\LcController@seljl");
Route::get("tel/jldetail/{id?}/{bianhao?}/{nickname?}", "pho\xyCenter\LcController@jldetail");
Route::get("tel/wszx/{nickname?}", "pho\xyCenter\LcController@wszx");

Route::get("tel/xyjspx/{name?}/{nickname?}", "pho\xyCenter\LcController@xyjspx");
Route::get("tel/xyjspxlist/{id?}/{class?}", "pho\xyCenter\LcController@xyjspxlist");
Route::get("tel/xylz/{nickname?}", "pho\XyCenter\LzController@lz");

//驾驶证服务
Route::get("tel/xyjszfw/{nickname?}", "pho\XyCenter\LzController@xyjszfw");
Route::get("tel/xyjr/{id?}/{nickname?}", "pho\XyCenter\LzController@xyjr");

//汽车服务
Route::get("tel/xyqc/{nickname?}", "pho\XyCenter\LzController@xyqc");
Route::get("tel/xyqcf/{id?}/{nickname?}", "pho\XyCenter\LzController@xyqcf");

//自主发布详情
Route::get("tel/zzfbdetails/{id}", "pho\Zzfb\ZzfbController@detail");

//学员中心圈子
Route::get("tel/xyqz/{nickname?}", "pho\XyCenter\LzController@xyqz");

/*
 * 圈子(在线论坛)
 */
Route::get("tel/forum/{nickname?}", "pho\Nav\ForumController@forum");
Route::get("tel/forumdetail/{id?}/{nickname?}", "pho\Nav\ForumController@forumdetails");

/*
 * 圈子(知识分享)
 */
Route::get("tel/qzzsfx/{nickname?}", "pho\Nav\QzController@zsfx");
Route::get("tel/qzzsfxdetail/{id?}/{nickname?}", "pho\Nav\QzController@details");

Route::group(['prefix' => 'jtel', "middleware" => "myjllogin"], function() {
    //教练中心导航入口
    ...
    Route::get("zzfbdetails/{id}", "pho\Zzfb\ZzfbController@detail");
    ...
    Route::get("tx/{nickname}", "pho\xyCenter\XyController@tx");
    Route::get("txmx/{nickname}", "pho\xyCenter\XyController@txmx");
...
Route::get("jtel/znxdel/{id}", "pho\Znx\ZnxController@znxdel");
