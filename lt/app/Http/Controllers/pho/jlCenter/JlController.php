...
//            }
    ...
    public function jlwdfb($nickname) {
        ...
        $jlinfo = DB::table("demo_grrz")->where("nickname","=",$nickname)->where("type","=","1")->orderby("id","desc")->first();
        ...
        $jllist = DB::table("demo_lzjszfw")->where("nickname","=",$nickname)->get();
        $qclist = DB::table("demo_lzqcfw")->where("nickname","=",$nickname)->get();
