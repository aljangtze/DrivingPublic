            ...
            <div class="fb_ul">
                <ul>
                    ...
                    <li>
                        ...
                        <div class="btn_xq" style="clear:both;height:28px;width:100%;"><a href="{{ url("tel/jldel")."/".$cc->id."/"."2" }}" style="border:1px solid #29A7E2;margin-top:5px;display:inline-block;padding:2px 10px;border-radius:5px;font-size:1.2rem;">删除</a></div>
                    </li>
                    @endforeach
                    ...
                    <li>
                        ...
                        <div class="btn_xq" style="clear:both;height:28px;width:100%;"><a href="{{ url("tel/jldel")."/".$ptt->id."/"."3" }}" style="border:1px solid #29A7E2;margin-top:5px;display:inline-block;padding:2px 10px;border-radius:5px;font-size:1.2rem;">删除</a></div>
                    </li>
                    @endforeach
                </ul>
            </div>
            ...
            <div class="fb_ul">
                <ul>
                    ...
                    <li>
                        ...
                        <div class="btn_xq" style="clear:both;height:28px;width:100%;"><a href="{{ url("tel/jldel")."/".$jll->id."/"."4" }}" style="border:1px solid #29A7E2;margin-top:5px;display:inline-block;padding:2px 10px;border-radius:5px;font-size:1.2rem;">删除</a></div>
                    </li>
                    @endforeach
                </ul>
            </div>
            ...
            <div class="fb_ul">
                <ul>
                    ...
                    <li>
                        ...
                        <div class="btn_xq" style="clear:both;height:28px;width:100%;"><a href="{{ url("tel/jldel")."/".$qcc->id."/"."5" }}" style="border:1px solid #29A7E2;margin-top:5px;display:inline-block;padding:2px 10px;border-radius:5px;font-size:1.2rem;">删除</a></div>
                    </li>
                    @endforeach
                </ul>
            </div>
