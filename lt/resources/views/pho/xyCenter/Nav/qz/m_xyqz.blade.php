...
<div class="basic_qz">
	<ul>
		<li>
			<a href="{{ url('tel/forum')."/".session()->get("Teluser") }}"><img src="{{ asset('phone/images/zxlt.png') }}" alt="晒一晒" /><p>晒一晒 </p></a>
		</li>
		<li>
			<a href="{{ url("tel/qzzsfx")."/".session()->get("Teluser") }}"><img src="{{ asset('phone/images/wypx.png') }}" alt="看一看" /><p>看一看 </p></a>
		</li>
	</ul>
</div>
<p class="m_fg"></p>
