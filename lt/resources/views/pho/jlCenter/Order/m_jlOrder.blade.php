...
<div class="qbdd_fl">
	<ul>
		<li @if($type == 0) class="fl_slect" @endif><a href="{{ url('jtel/jlorder')."/".session()->get("jTeluser")."/"."0" }}">全部订单 <em>({{ $allcount }})</em></a></li>
		<li @if($type == 2) class="fl_slect" @endif><a href="{{ url('jtel/jlorder')."/".session()->get("jTeluser")."/"."2" }}">未付款 <em>({{ $wcount }})</em></a></li>
		<li @if($type == 1) class="fl_slect" @endif><a href="{{ url('jtel/jlorder')."/".session()->get("jTeluser")."/"."1" }}">已付款 <em>({{ $ycount }})</em></a></li>
	</ul>
</div>
<script>
	$(function(){
...
<ul class="m_all_order">
	...
	<li>
		<div class="order_head">
			<p><a href="{{ url('jtel/xqorderdetail')."/".$tmp->id."/".session()->get("jTeluser") }}" class="dhyc_p">{{ $tmp->title }} <em>></em></a><span>交易成功</span></p>
		</div>
		<div class="order_body">
		  <a href="{{ url('jtel/xqorderdetail')."/".$tmp->id."/".session()->get("jTeluser") }}">
		...
		<div class="btn_state_box">
			...
			<button type="button" class="btn_state" style="border:1px solid #29A7E2;"><a href="tel:18988484593" style="color:#29A7E2;">客服</a></button>
                        <a href="{{ url('jtel/xqsqdel')."/".$tmp->id."/".session()->get("jTeluser") }}"><button type="button" class="btn_state">删除订单</button></a>
		</div>
		<p class="m_fg"></p>
	</li>
        @endif
	...
	<li>
		<div class="order_head">
			<p><a href="{{ url('jtel/xqorderdetail')."/".$tmpa->id."/".session()->get("jTeluser") }}" class="dhyc_p">{{ $tmpa->title }} <em>></em></a><span style="color:#111">已付款</span></p>
		</div>
		<div class="order_body">
		  <a href="{{ url('jtel/xqorderdetail')."/".$tmpa->id."/".session()->get("jTeluser") }}">
<!--			<div class="order_img column">
		...
		<div class="btn_state_box">
                        <button type="button" class="btn_state"><a href="#">线下已付清</a></button>
			<button type="button" class="btn_state" style="border:1px solid #29A7E2;"><a href="tel:18988484593" style="color:#29A7E2;">客服</a></button>
			<button type="button" class="btn_state" style="border:1px solid #D9534F;color:#D9534F"><a href="{{ url('jtel/xqtrueorder')."/".$tmpa->id."/".session()->get("jTeluser") }}" style="color:#D9534F">确认收款</a></button>
		</div>
		<p class="m_fg"></p>
	</li>
        @endif
	...
	<li>
		<div class="order_head">
			<p><a href="{{ url('jtel/xqorderdetail')."/".$tmpb->id."/".session()->get("jTeluser") }}" class="dhyc_p">{{ $tmpb->title }} <em>></em></a><span>未付款</span></p>
		</div>
		<div class="order_body">
		  <a href="{{ url('jtel/xqorderdetail')."/".$tmpb->id."/".session()->get("jTeluser") }}">
<!--			<div class="order_img column">
				<img src="{{ asset('phone/images/jx.jpg') }}">
			</div>-->
			<div class="order_sx column">
		...
		<!--操作状态-->
		<div class="btn_state_box">
			<button type="button" class="btn_state" style="border:1px solid #D9534F;"><a href="{{ url('jtel/xqpayorder')."/".$tmpb->id."/".session()->get("jTeluser") }}" style="color:#D9534F;">线下未付清</a></button>
			<button type="button" class="btn_state" style="border:1px solid #29A7E2;"><a href="tel:18988484593" style="color:#29A7E2;">客服</a></button>
