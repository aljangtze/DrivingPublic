...
<div class="basic_hp">
	<ul>
		<li>
			<a href="{{ url('jtel/lzjrzfw')."/".session()->get("jTeluser") }}"><img src="{{ asset('phone/images/jsz.png') }}" alt="驾证服务发布" /><p>驾证服务发布 </p></a>
		</li>
		<li>
			<a href="{{ url('jtel/lzqcfw')."/".session()->get("jTeluser") }}"><img src="{{ asset('phone/images/qcfw.png') }}" alt="车辆服务发布" /><p>车辆服务发布 </p></a>
		</li>
		<li>
