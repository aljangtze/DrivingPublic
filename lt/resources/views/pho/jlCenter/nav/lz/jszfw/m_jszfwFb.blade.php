...
<header class="header">
	...
	<p style="width:84%;text-align:center;color:#fff;height:40px; line-height:40px;">驾驶证服务发布</p>
</header>
<!--驾驶证服务内容-->
<div class="vip_class">
	<div class="jm1">
		<form action="{{ url('jtel/savelzjrzfw')."/".session()->get("jTeluser") }}" method="post">
			...
			<div class="fenshu">
				...
				<select name="fwitem" id="fwxm">
					<option value="1">到期换证</option>
					<option value="2">补办驾证</option>
					<option value="3">异地转入</option>
					<option value="4">驾证年审</option>
					<option value="5">违章查询</option>
					<option value="6">罚单代缴</option>
				</select>
			</div>
			<div class="fenshu">
				<label>服务价格</label>
