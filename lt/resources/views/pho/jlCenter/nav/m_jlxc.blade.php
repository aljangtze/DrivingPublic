...
<div class="basic_hp">
	<ul>
		<li>
			<a href="{{ url('jtel/jlxyxq')."/".session()->get("jTeluser") }}"><img src="{{ asset('phone/images/fbxq.png') }}" alt="学员需求" /><p>学员需求 </p></a>
		</li>
		<li>
			<a href="{{ url("jtel/addclass")."/".session()->get("jTeluser") }}"><img src="{{ asset('phone/images/vip.png') }}" alt="班型发布" /><p>班型发布</p></a>
		</li>
		<li>
			<a href="{{ url("jtel/lession")."/".session()->get("jTeluser") }}"><img src="{{ asset('phone/images/jsxm.png') }}" alt="计时项目发布" /><p>计时培训发布 </p></a>
		</li>
		<li>
			<a href="{{ url('jtel/wszx')."/".session()->get("jTeluser") }}"><img src="{{ asset('phone/images/zxpx.png') }}" alt="网上自学" /><p>网上自学 </p></a>
		</li>
		<li>
