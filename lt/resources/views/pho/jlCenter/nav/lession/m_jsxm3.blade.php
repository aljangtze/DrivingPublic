...
<header class="header">
	...
	<p style="width:84%;text-align:center;color:#fff;height:40px; line-height:40px;">科目三发布</p>
</header>
<!--汽车服务内容-->
<div class="vip_class">
	<div class="jm1">
            <form action="{{ url('jtel/savelessionthree')."/".session()->get("jTeluser") }}" method="post">
			...
			<div class="fenshu">
				...
				<select id="select_ms" name="lxmodel">
					<option value="0">请选择练习模式</option>
					<option value="1">考试路训</option>
					<option value="2">长途路训</option>
					<option value="3">考试路训（考试车）</option>
				</select>
			</div>
