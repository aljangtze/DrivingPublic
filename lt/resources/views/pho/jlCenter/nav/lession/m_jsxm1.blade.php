...
<header class="header">
	...
	<p style="width:84%;text-align:center;color:#fff;height:40px; line-height:40px;">科目一发布</p>
</header>
<!--汽车服务内容-->
<div class="vip_class">
	<div class="jm1">
            <form action="{{ url('tel/postlessionone')."/".session()->get("Teluser") }}" method="post">
