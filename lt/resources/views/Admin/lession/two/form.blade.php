...
<body>
    ...
    <ul class="forminfo">
        <form action="{{ url('admin/lessiontwo')."/".$str->id }}" method='post'>
            ...
            <li><label>练习模式</label><input name="lxmodel" type="radio" value="1" @if($str->lxmodel == 1) checked @endif />场地练习&nbsp;&nbsp;&nbsp;&nbsp;<input name="lxmodel" type="radio" @if($str->lxmodel == 2) checked @endif  value="2" />考试车联系</cite></li>
