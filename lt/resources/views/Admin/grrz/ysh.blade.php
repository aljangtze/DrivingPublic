...
<div class="info_box">
	...
	<form class="form-inline form_ss">
		...
		<div class="search_nr" id="sscs">
			<ul>
                            <form action="{{ url('admin/grjpfw')."/"."1"."/"."edit" }}" method="get">
	...
	<div class="tb_operation">
                ...
                <a href="{{ url('admin/grjpfw') }}"><button type="button" class="btn btn-success">（{{ $count }}）未审核</button></a>
	</div>
...
<!--				<td>教练证或工作证</td>
			...
			<tr>
				...
				<td>{{ $tmp->jxaddress }}</td>
<!--                                <td>
                                    <a href="{{ asset('jlzpic')."/".$tmp->jlzpic }}"><img width="80px" height="50px" src="{{ asset('jlzpic')."/s_".$tmp->jlzpic }}"></a>
                                </td>
                                <td>
                                    <a href="{{ asset('sfzpicz')."/".$tmp->sfzpicz }}"><img width="80px" height="50px" src="{{ asset('sfzpicz')."/s_".$tmp->sfzpicz }}"></a>
                                </td>
                                <td>
                                    <a href="{{ asset('jszpicz')."/".$tmp->jszpicz }}"><img width="80px" height="50px" src="{{ asset('jszpicz')."/s_".$tmp->jszpicz }}"></a>
                                </td>
                                <td>
                                    <a href="{{ asset('jlcxszpic')."/".$tmp->jlcxszpic }}"><img width="80px" height="50px" src="{{ asset('jlcxszpic')."/s_".$tmp->jlcxszpic }}"></a>
                                </td>
                                <td>
                                    <a href="{{ asset('jlcpic')."/".$tmp->jlcpic }}"><img width="80px" height="50px" src="{{ asset('jlcpic')."/s_".$tmp->jlcpic }}"></a>
                                </td>
                                <td>
                                    <a href="{{ asset('grpic')."/".$tmp->grpic }}"><img width="80px" height="50px" src="{{ asset('grpic')."/s_".$tmp->grpic }}"></a>
                                </td>-->
                                <td>
                                    @if($tmp->sh == 2)
                                ...
                                <td>{{ $tmp->shdate }}</td>
                                <td>
                                    @if($tmp->sha == 1) <font color="blue">已通过</font> @endif
                                    @if($tmp->sha == 2) <font color="red">未通过</font> @endif
                                </td>
				<td>
					<a href="{{ url('admin/grjpedit')."/".$tmp->id }}" class="btn btn-info" target="rightFrame">修改</a>
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body">
                                                          <textarea class="form-control" rows="3" name="info" placeholder="请填写审核信息"></textarea>
                                                              <input type="radio" name="sha" id="optionsRadios1" @if($tmp->sha == 1) checked @endif value="1">
                                                                  通过&nbsp;&nbsp;&nbsp;
                                                              <input type="radio" name="sha" id="optionsRadios1"@if($tmp->sha == 2) checked @endif value="2">
                                                             未通过&nbsp;&nbsp;&nbsp;
                                                          </div>
                                                        </div>
                                                    </div>
