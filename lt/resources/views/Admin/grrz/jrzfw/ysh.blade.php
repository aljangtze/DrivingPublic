...
<div class="info_box">
	...
	<form class="form-inline form_ss">
		...
		<div class="search_nr" id="sscs">
			<ul>
                            <form action="{{ url('admin/grqcfw')."/"."1"."/"."edit" }}" method="get">
	...
	<div class="tb_operation">
                ...
                <a href="{{ url('admin/grjrzfw') }}"><button type="button" class="btn btn-success">（{{ $count }}）未审核</button></a>
	</div>
