...
<body>
    ...
    <div class="formtitle"><span>支付使用说明设置</span></div>
    
    <ul class="forminfo">
        <form action="{{ url('admin/setinfo') }}" method="post" enctype="multipart/form-data">
...
<!--        <li><label>文章标题</label><input name="title" type="text" class="dfinput" /><i></i></li>
        ...
        <li><label>文章内容</label><textarea id="content" style="width:90%;height:800px" name="zfsm" style="margin-left:85px;">{!!$str->zfsm!!}</textarea></li>
