...
<body>
    ...
    <div class="formtitle"><span>汽车服务支付说明设置</span></div>
    
    <ul class="forminfo">
        <form action="{{ url('admin/setinfo/qcsave')."/".$str->id }}" method="post" enctype="multipart/form-data">
...
<!--        <li><label>文章标题</label><input name="title" type="text" class="dfinput" /><i></i></li>
        ...
        <li><label>文章内容</label><textarea id="content" style="width:90%;height:800px" name="qcfwsysm" style="margin-left:85px;">{!!$str->qcfwsysm!!}</textarea></li>
