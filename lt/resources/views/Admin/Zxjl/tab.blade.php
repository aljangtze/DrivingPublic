...
<div class="info_box">
	...
	<form class="form-inline form_ss">
		...
		<div class="search_nr" id="sscs">
			<ul>
				<li>
                                    <form action="{{ url('admin/zxjl') }}" method="get">
	...
	<div class="tb_operation">
		...
		<a href="{{ url('admin/zxjlysh') }}"><button type="button" class="btn btn-success">（{{ $count }}）已审核</button></a>
	</div>
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>{{ $tmp->sfzh }}</td>
                                ...
                                <td><font color="red">等待审核</font></td>
				<td>
                                        ...
                                        <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="{{ url('admin/zxjlsh')."/".$tmp->id }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <input type="hidden" name="qf" value="{{ $tmp->qf }}"/>
