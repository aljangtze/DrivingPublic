...
<div class="info_box">
	...
	<form class="form-inline form_ss">
		...
		<div class="search_nr" style="display:none;" id="sscs">
			<ul>
                            <form action="{{ url('admin/qcfw') }}" method="get">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
				<li>
					<div class="form-group">
						<label class="">姓名</label>
						<input type="text" name="name" class="form-control" placeholder="输入分公司名称" />
					</div>
				</li>
				<li>
					<div class="form-group">
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>{{ $tmp->id }}</td>
                                ...
                                <td>
                                    <a href="{{ asset('frsfzpicf')."/".$tmp->frsfzpicf }}"><image width="80px" height="50px" src="{{ asset('grsfzpicf/s_').$tmp->grsfzpicf }}"></a>
                                </td>
                                <td>
                                    @if($tmp->sh == 1)
