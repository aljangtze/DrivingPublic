...
<header class="header">	
	...
	<p style="width:84%;text-align:center;color:#fff;height:40px; line-height:40px;">汽车服务</p>
</header>
<!--当前所在城市-->
<div class="dq_city">
	<p>您所在位置：<span>云南省昆明市</span></p>
	<form action="{{ url('tel/xyqc')."/".session()->get("Teluser") }}" method="get">
...
<div class="jlxx_fl">
	<ul>
		<li class="fl_slect"><a href="{{ url('tel/xyqc')."/".session()->get("Teluser") }}">默认排序</a></li>
		<li><a href="#">成交数量 ↓</a></li>
	</ul>
</div>
<script>
...
<div class="coach_box">
	<ul style="margin-top:10px;">
		...
		<li>
			<a href="{{ url('tel/xyqcf')."/".$tmp->id."/".session()->get("Teluser") }}">
				<div class="coach_img">
					<img src="{{ asset('dppic')."/".$tmp->dppic }}" />
				</div>
			</a>
			<div class="coach_xx">
				<p><a href="{{ url('tel/xyqcf')."/".$tmp->id."/".session()->get("Teluser") }}">{{ $tmp->name }}</a></p>
				<!--<p>价格：￥200</p>-->
				<p>成交量：40</p>
