...
$sql="Insert into dingdan(a,b,c,d,e,f,g,h,i,j,k,l,m,n) values('$a','$b','$c','$d','$e','微信支付','$g','$order_sn','$i','2','$k','$journalTime','$m','$n')";
mysql_query($sql);
...
$sql="Insert into dingdan(a,b,c,d,e,f,g,h,i,j,k,l,m,n) values('$a','$b','$c','$d','$e','支付宝支付','$g','$order_sn','$i','2','$k','$journalTime','$m','$n')";
mysql_query($sql);
mysql_query("set names 'utf8'");
