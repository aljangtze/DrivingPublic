...
//=================================================================jquery.cookie Start=======================================
    ...
    $(function() {
        ...
        if($.cookie(COOKIE_NAME)){
            ...
            $(".alert_windows").css({'top': erdangjiadeH/2-$(".alert_windows").height()/2,'left': erdangjiadeW/2-$(".alert_windows").width()/2 });
            $(".alert_windows").slideDown(300, function() {
